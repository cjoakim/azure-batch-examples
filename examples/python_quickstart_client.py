...
#
# Submit this job with: '$ python python_quickstart_client.py'
# Note: the Batch task simply executes a 'cat'; see the 'add_tasks' method.
...
# global
_BATCH_ACCOUNT_NAME     = os.environ["AZURE_BATCH_ACCOUNT"]
_BATCH_ACCOUNT_KEY      = os.environ["AZURE_BATCH_KEY"]
_BATCH_ACCOUNT_URL      = os.environ["AZURE_BATCH_URL"]
_STORAGE_ACCOUNT_NAME   = os.environ["AZURE_STORAGE_ACCOUNT"]
_STORAGE_ACCOUNT_KEY    = os.environ["AZURE_STORAGE_KEY"]
